...
def show(datas):
    # with open(f'../Result/Evaluation_improve/save_.json', 'r') as rf:
    #     datas = json.load(rf)
    rows = []
    ...
    # 保存为 Excel 文件
    output_path = "../Result/Evaluation_improve/output2.xlsx"
...
def show0():
    ...
    # 保存为 Excel 文件
    output_path = "../Result/Evaluation_improve/output1.xlsx"
    df.to_excel(output_path, index=False, engine="openpyxl")
    print(f"JSON 数据已整理并导出为 Excel 文件：{output_path}")


def sum_intergrate():
    SBFL_LIST = ["SBFL", "GBSR_FOR_SBFL_0", "GBSR_FOR_SBFL_1", "GBSR_FOR_SBFL_2", "GBSR_FOR_SBFL_3", "GBSR_FOR_SBFL_4",
                 "GBSR_FOR_SBFL_5", "GBSR_FOR_SBFL_6", "GBSR_FOR_SBFL_7", "GBSR_FOR_SBFL_8"]
    MBFL_LIST = ["MBFL", "GBSR_FOR_MBFL_0", "GBSR_FOR_MBFL_1", "GBSR_FOR_MBFL_2", "GBSR_FOR_MBFL_3", "GBSR_FOR_MBFL_4",
                 "GBSR_FOR_MBFL_5", "GBSR_FOR_MBFL_6", "GBSR_FOR_MBFL_7", "GBSR_FOR_MBFL_8"]
