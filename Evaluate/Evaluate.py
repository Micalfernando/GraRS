...
def MBFL_Evaluate():
    ...
    for subject_name in Subject_name:
        ...
        path = f"F:\GB4FL\Result\Evaluation_improve\{subject_name}_MBFL.json"
...
def SBFL_Evaluate():
    ...
    for subject_name in Subject_name:
        ...
        path = f"F:\GB4FL\Result\Evaluation_improve\{subject_name}_SBFL.json"
        ensure_directory_exists(path)
    ...
    for type_ in type_list:
        ...
        for subject_name in Subject_name:
            with open(f'../Data/{subject_name}.json', 'r') as rf:
                datas = json.load(rf)
            print("GET JSON FILE FINISHED!", end='\n\n')
            with open(f'../Result/Suspicious/{subject_name}/GBSR_FOR_SBFL_{type_}_0.json', 'r') as rf:
                suspicious_datas = json.load(rf)
            SBFL_evaluate_dic = {}
            for data in datas:
                fault_location = data["ans"]
                ...
                for formula in formula_list:
                    ...
                    evaluate_dic_formula[formula] = this_formula_max_dic
                SBFL_evaluate_dic[version_name] = evaluate_dic_formula
            path = f"F:\GB4FL\Result\Evaluation\{subject_name}_GBSR_FOR_SBFL_{type_}_0.json"
            ensure_directory_exists(path)
            Save_json(SBFL_evaluate_dic, path)
    ...
    for type_ in type_list:
        ...
        for subject_name in Subject_name:
            with open(f'../Data/{subject_name}.json', 'r') as rf:
                datas = json.load(rf)
            print("GET JSON FILE FINISHED!", end='\n\n')
            with open(f'../Result/Suspicious/{subject_name}/GBSR_FOR_MBFL_{type_}_0.json', 'r') as rf:
                suspicious_datas = json.load(rf)
            SBFL_evaluate_dic = {}
            for data in datas:
                fault_location = data["ans"]
                ...
                for formula in formula_list:
                    ...
                    evaluate_dic_formula[formula] = this_formula_max_dic
                SBFL_evaluate_dic[version_name] = evaluate_dic_formula
            path = f"F:\GB4FL\Result\Evaluation\{subject_name}_GBSR_FOR_MBFL_{type_}_0.json"
            ensure_directory_exists(path)
            Save_json(SBFL_evaluate_dic, path)
