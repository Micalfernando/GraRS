...
def integration(M1, M2, M4, M4_1, L1, L2,  L4, L5):
...
if __name__ == '__main__':
    ...
    for subject_name in Subject_name:
        ...
        for data in datas:
            ...
            matrix = integration(method2method_matrix, method2lines_matrix,
                                 lines2rtest_matrix, lines2ftest_matrix
                                 , len_method, len_lines, len_rtest,
                                 len_ftest)
            print(f'------获取{data_name}图矩阵成功！--------')

            # P_file_path = f'''../SimpleMatrix/{subject_name}/P_{data_name}_matrix.pkl'''
            file_path = f'''../SimpleMatrix/{subject_name}/{data_name}_matrix.pkl'''
