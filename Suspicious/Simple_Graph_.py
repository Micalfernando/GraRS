...
def Deal_SBFL(cal_weight):
    ...
    for subject_name in Subject_name:
        ...
        with open(f"../Result/Weight_Simple/{subject_name}.json", "r") as f:
        ...
        for sus_subject_no, sus_method_list in suspicious_datas.items():
            ...
            this_weight_value = this_weight_data["value"]
            ...
            for sus_method_no, sus_dif_cal_data in sus_method_list.items():
                p_value = weight_datas[sus_subject_no]["value"][int(sus_method_no)]
                this_method_dic = {}
                for formula in formula_list:
        ...
        Save_path = f"""../Result/Suspicious_Simple/{subject_name}/GBSR_FOR_SBFL_{cal_weight}.json"""
    ...
    for subject_name in Subject_name:
        ...
        for sus_subject_no, sus_method_list in suspicious_datas.items():
            ...
            for sus_method_no, sus_dif_cal_data in sus_method_list.items():
                ...
                this_subject_dic[sus_method_no] = this_method_dic
            save_json[sus_subject_no] = this_subject_dic
        Save_path = f"""../Result/Suspicious_simple/{subject_name}/GBSR_FOR_MBFL_{cal_weight}.json"""
        ensure_directory_exists(Save_path)
        Save_json(save_json, Save_path)
    # for k, v in save_json.items():
    #     print(k, "\n", v)
